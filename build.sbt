...
lazy val root = (project in file(".")).
  ...
  settings(
    ...
    description := "Jsdom API bindings for Scala.js",
    version := apiVersion,
...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/scalajs-io/jsdom</url>
      <licenses>
        <license>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/jsdom.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/jsdom.git</developerConnection>
        <url>github.com/scalajs-io/jsdom.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
